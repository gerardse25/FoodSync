...
def update_item(
    client, home_id, item_id, headers, *, quantity=None, extra_payload=None
):
    payload = {}
...
def create_item_and_get_id(
    client, home_id, headers, *, product_name, quantity, notes=None
):
    response = add_item(
        client,
        home_id,
...
def test_update_rejects_payload_with_quantity_and_product_name(
...
def test_update_rejects_payload_with_quantity_product_name_and_notes(
    client, shared_home_setup
):
    home_id = shared_home_setup["home_id"]
    headers = shared_home_setup["owner_headers"]

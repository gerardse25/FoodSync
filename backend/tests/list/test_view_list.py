...
def test_view_shopping_list_returns_null_notes_when_not_present(
...
def test_user_without_authentication_cannot_view_shopping_list(
    client, shared_home_setup
):
    home_id = shared_home_setup["home_id"]
...
def test_user_not_in_home_cannot_view_shopping_list(
    client, shared_home_setup, outsider_user
):
    home_id = shared_home_setup["home_id"]
